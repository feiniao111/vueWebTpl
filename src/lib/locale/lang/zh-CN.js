export default {
  ...
  page: { // 页面级组件
    examples: {
      ...
      onekeyExportChn: '一键导出项目中文语言文件(Excel)',
      onekeyExportBoth: '一键导出项目中、英文语言文件(Excel)',
      genLangFile: '生成Json语言包',
      genExcelFile: '导出Excel语言文件',
      uploadExcelHint: '请上传excel语言文件',
      uploadJsonHint: '请上传Json中文语言文件',
      uploadJsonHint2: '请上传Json英文语言文件',
      optional: '（可选）',
      uploadiFirst: '请先上传一个Excel语言文件',
      uploadiFirst2: '请先上传一个中文Json语言文件',
      excel2json: 'excel一键生成语言包',
      json2excel: '语言包一键生成excel',
      nicknameModify: '昵称修改'
    },
    pageDemo1: {
      en: '英语',
